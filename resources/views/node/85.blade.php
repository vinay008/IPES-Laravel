  ...
  <section id="main" class="main" role="main">
    ...
    <div id="block-zircon-content" class="block block-system block-system-main-block">
             @foreach($data as $da)
                ...
                <p><b>Paper/Presentation File :</b><a href="uploads/{{$da->image_url}}" download="uploads{{$da->image_url}}">{{$da->image_url}}</a></p>
                <p></p><p></p>
                <p>
                <p><b>Status:</b>{{$da->status}}</p>
                <a href="uploads/{{$da->image_url}}" download="uploads/{{$da->image_url}}"><b><u>View And Download</u></b></a>
                
                 <a href=" {{ route('approve85',['doneapp'=>$da->id]) }}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><u>Approve Paper</u></b></a>

                 <a href="{{ route('reject85',['rejapp'=>$da->id]) }}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><u>Reject Paper</u></b></a>
                </p>
