...
<header id="header" class="header" role="header">
  ...
  <section id="main" class="main" role="main">
    ...
    <div id="block-zircon-content" class="block block-system block-system-main-block">
      ...
      <form class="register-form" data-drupal-selector="register-form" action="71" method="post" id="register-form" accept-charset="UTF-8">
                 {{ csrf_field()}}
  <div class="js-form-item form-item js-form-type-textfield form-type-textfield js-form-item-title form-item-title">
      <label for="edit-title" class="js-form-required form-required">Title:</label>
        <input data-drupal-selector="edit-title" type="text" id="edit-title" name="title" value="" size="60" maxlength="128" class="form-text required" required="required" aria-required="true" />
...
<div class="js-form-item form-item js-form-type-number form-type-number js-form-item-zip-code form-item-zip-code">
      <label for="edit-zip-code" class="js-form-required form-required">ZIP:</label>
        <input data-drupal-selector="edit-zip-code" type="number" id="edit-zip-code" name="zip_code" value="" step="1" class="form-number required" required="required" aria-required="true" />
...
<div class="js-form-item form-item js-form-type-textfield form-type-textfield js-form-item-state form-item-state">
      <label for="edit-state" class="js-form-required form-required">State:</label>
        <input data-drupal-selector="edit-state" type="text" id="edit-state" name="state" value="" size="60" maxlength="128" class="form-text required" required="required" aria-required="true" />
...
<div class="js-form-item form-item js-form-type-textfield form-type-textfield js-form-item-country form-item-country">
      <label for="edit-country" class="js-form-required form-required">Country:</label>
        <input data-drupal-selector="edit-country" type="text" id="edit-country" name="country" value="" size="60" maxlength="128" class="form-text required" required="required" aria-required="true" />
...
<div class="js-form-item form-item js-form-type-password form-type-password js-form-item-cpassword form-item-cpassword">
      <label for="edit-cpassword" class="js-form-required form-required">Confirm Password:</label>
        <input data-drupal-selector="edit-cpassword" type="password" id="edit-cpassword" name="confirm" size="60" maxlength="128" class="form-text required" required="required" aria-required="true" />

        </div>
<input data-drupal-selector="form-pauxhbv-ofxmj1f2j6cfdyq-gqm-ninoql9wsytu50a" type="hidden" name="form_build_id" value="form-PauXHBv-OFxMj1F2J6CfDyq_GqM-NINOQL9wsYTu50A" />
<input data-drupal-selector="edit-register-form" type="hidden" name="form_id" value="register_form" />

<div data-drupal-selector="edit-actions" class="form-actions js-form-wrapper form-wrapper" id="edit-actions"><input data-drupal-selector="edit-submit" type="submit" id="edit-submit" name="op" value="Register" class="button button--primary js-form-submit form-submit" />
</div>
