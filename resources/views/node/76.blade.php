...
<link rel="shortcut icon" href="../sites/all/themes/zircon/ipeslogo.png" type="image/png" />
    ...
    <title>Uplaod Paper's Or Presentation| IPES</title>
...
<header id="header" class="header" role="header">
  ...
  <section id="main" class="main" role="main">
   ...
   <form class="uploadppt-form" data-drupal-selector="uploadppt-form" enctype="multipart/form-data" action="76" method="post" id="uploadppt-form" accept-charset="UTF-8">
     <input type="hidden" name="_token" value="{{ csrf_token() }}">

  <div class="js-form-item form-item js-form-type-email form-type-email js-form-item-u-email form-item-u-email">
      <label for="edit-u-email" class="js-form-required form-required">Your Email ID:</label>
        <input data-drupal-selector="edit-u-email" type="email" id="edit-u-email" name="u_email" value="{{Auth::user()->email}}" size="60" maxlength="254" class="form-email required" required="required" aria-required="true" readonly/>
...
<div class="js-form-item form-item js-form-type-textfield form-type-textfield js-form-item-paper-title form-item-paper-title">
      <label for="edit-paper-title" class="js-form-required form-required">Title of paper:</label>
...
<div id="ajax-wrapper"><div class="js-form-item form-item js-form-type-managed-file form-type-managed-file js-form-item-paper-ppt-file form-item-paper-ppt-file">
      <label for="edit-paper-ppt-file-upload" class="js-form-required form-required">Upload Presentation:</label>
...
</div><div class="js-form-item form-item js-form-type-select form-type-select js-form-item-key1 form-item-key1">
      <label for="edit-key1">Keyword 1:</label>
        <select data-drupal-selector="edit-key1" id="edit-key1" name="key1" class="form-select"><option value=" ">Select keyword</option><option value="Capital Markets">Capital Markets</option><option value="Debt">Debt</option><option value="MNCs">MNCs</option><option value="Globalization">Globalization</option></select>
        </div>
<div class="js-form-item form-item js-form-type-select form-type-select js-form-item-key2 form-item-key2">
      <label for="edit-key2">Keyword 1:</label>
        <select data-drupal-selector="edit-key2" id="edit-key2" name="key2" class="form-select"><option value=" ">Select keyword</option><option value="Capital Markets">Capital Markets</option><option value="Debt">Debt</option><option value="MNCs">MNCs</option><option value="Globalization">Globalization</option></select>
        </div>

<div data-drupal-selector="edit-actions" class="form-actions js-form-wrapper form-wrapper" id="edit-actions"><input data-drupal-selector="edit-submit" type="submit" id="edit-submit" value="Upload File(s)" class="button button--primary js-form-submit form-submit" />
</div>
    @endif 
</form>
